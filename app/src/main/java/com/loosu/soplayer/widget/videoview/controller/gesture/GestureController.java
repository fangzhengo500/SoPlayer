...
public class GestureController extends AbsGestureController {
    private static final String TAG = "GestureController2";
    ...
    public GestureController(@NonNull Context context) {
        ...
        addGestureDetector(new VolumeGestureDetector(getContext(), this));
        addGestureDetector(new BrightnessGestureDetector(getContext(), this));
        addGestureDetector(new SeekGestureDetector(getContext(), this));
        addGestureDetector(new ClickDetector(getContext(), this));
    }
